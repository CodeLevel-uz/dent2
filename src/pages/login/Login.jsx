...
function Login() {
    ...
    const login = (e) => {
        e.preventDefault()
        axios.get(`${url}/organizations/login?login=${loginRef.current.value}&password=${passwordRef.current.value}`)
        .then((res) => {
                ...
                <div className="authentication-inner">
                    <div className="card">
                        <div className="card-body">
                            ...
                            <h4 className="mb-2 justify-content-center text-center" style={{color: "#152b03", fontWeight: "700"}}>Dent admin paneliga xush kelibsiz!</h4>
                            <form onSubmit={login}>
                                <div className="mb-3">
